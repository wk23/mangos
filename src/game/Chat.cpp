...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { "crarena",        SEC_ADMINISTRATOR,  false, &ChatHandler::HandleSendCommandResultArena,     "", NULL },
        { "crguild",        SEC_ADMINISTRATOR,  false, &ChatHandler::HandleSendCommandResultGuild,     "", NULL },
        { "crparty",        SEC_ADMINISTRATOR,  false, &ChatHandler::HandleSendCommandResultParty,     "", NULL },
        { "crauction",      SEC_ADMINISTRATOR,  false, &ChatHandler::HandleSendCommandResultAuction,   "", NULL },
